...
_SYSTEM_PROMPT_TEMPLATE = """你是一个专业的游戏本地化翻译引擎。
...
- addition：附加信息字典。包含若干项辅助信息，文本值翻译成 __TARGET_LANG__，非文本结构原样保留。
...
5. 文本中可能出现笔误与非标准用法，请尽量理解原意并翻译，而不是逐字逐句直译。
6. 通常只包含一种语言，对于意义不明的语句，可以视作干扰，进行舍弃"""
